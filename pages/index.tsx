...
const Home = ({
  ...
  return (
    ...
    >
      ...
      <Header setMoviesFromSearch={setMoviesFromSearch} />
      ...
      <main className="relative pl-4 pb-24 lg:space-y-24 lg:pl-16 ">
        ...
        <section className="md:space-y-24">
          {moviesFromSearch?.length > 0 && (
            <Row
              title={`Search`}
              // title={`Search : ${moviesFromSearch[0].title}`}
              movies={moviesFromSearch}
            />
          )}
          <Row title="Trending Now" movies={trendingNow} />
          {/* <Row title="Popular Now" movies={popular} /> */}
          <Row title="Upcomming" movies={upcomingMovies} />
